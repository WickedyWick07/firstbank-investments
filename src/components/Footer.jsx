...
const Footer = () => {
  // Media query to check if the screen is mobile (or smaller than medium size)
  const isMobile = useMediaQuery({ query: '(max-width: 768px)' });

  return (
    <div className='bg-secondBlue'>
      <section className='py-8 px-4 mx-auto'>
        <footer className={`flex ${isMobile ? 'flex-col' : 'flex-row'} justify-between mx-4 md:mx-40 text-center md:text-left`}>
